<%@ Page Title="" Language="C#" MasterPageFile="~/MasterBloodBank.Master" AutoEventWireup="true" CodeBehind="EditProfile.aspx.cs" Inherits="Virtual_Blood_Bank.EditProfile" %>
    ...
    <div>
        ...
        <div class="row mb-2">
            <div class="col-8 bg-light text-light p-4">
                <h2 class="text-center text-danger">Edit Profile Form</h2>
                <div>
                    <table class="container">
                        ...
                        <tr class="row pt-3">
                            ...
                            <td class="col-6 TextFieldUpperText" >Last Donation Date<br />
                                <%--   <i class="fas fa-user-tie fa-10x"></i>--%>
                                <asp:TextBox ID="LastDonateTextBox" runat="server" Placeholder="day/month/year" CssClass="datepickerblooddonate form-control disabled"></asp:TextBox>
                        ...
                        <tr class="row">
                           <td class="col-md-1"></td>
                            <td class="col-md-8 mt-3">
                                <asp:Button CssClass="btn btn-danger btn-block" ID="UpdateProfile" runat="server" Text="Update" OnClick="UpdateProfile_Click" />
                                <asp:Label ID="updateLabel" runat="server" Font-Size="Small" ForeColor="#FF3300" Text="Label" Visible="False"></asp:Label>
